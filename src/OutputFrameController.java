...
public class OutputFrameController {
    ...
    private boolean allBotMode;
    private Bot bot;
    private Bot extraBot;
     ...
     *
     */
    void getInput(String name1, String name2, String rounds, boolean isBotFirst, String botType, boolean allBotMode) {
